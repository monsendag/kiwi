...
% Check if R consist of 1 rank, or several, e.g. [2 2 1]
if numel(R) == 1
    R = R * ones(N,1); % extend R to [R R R]
end

% create an N-by-1 cell array of empty matrices
U = cell(N,1);
...
for iter = 1:maxiters
    ...
    for n = dimorder(1:end)
        ...
        % EXTRA: compute the r leading eigenvalues of Utilde_n * Utilde_n'
        % i.e. keep only the most significant eigenvalues according to the rank
